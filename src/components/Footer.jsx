            ...
            <div className="col-sm-12 col-md-4">
              <div className="widget-a">
                ...
                <div className="w-body-a">
                  ...
                  we are passionate about helping you find the perfect property, whether you are buying, selling, or renting. With years of experience in the real estate market, our dedicated team is committed to providing expert guidance and personalized service that ensures a smooth and successful experience.
                  </p>
                </div>
                <div className="w-footer-a">
                  <ul className="list-unstyled">
                    ...
                    <li className="color-a">
                      <span className="color-text-a">Email .</span> +92 306 7093525
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="col-md-12">
            ...
            <div className="copyright-footer">
              <p className="copyright color-text-a">
                &copy; Copyright <span className="color-a">Real Estate Agency</span> All Rights Reserved.
              </p>
            </div>
