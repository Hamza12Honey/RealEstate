            ...
            <div className="row">
              <div className="col-md-12 col-lg-8">
                <div className="title-single-box">
                  ...
                  We’re here to assist you with all your real estate needs. Whether you’re buying, selling, or renting, our team of experienced professionals is ready to provide expert guidance and personalized service.

Please feel free to reach out to us with any questions or to schedule a consultation. We value open communication and are eager to help you find your dream property or get the best value for your current one.
                  </span>
                </div>
              </div>
                    ...
                    <div className="icon-box section-b2">
                      ...
                      <div className="icon-box-content table-cell">
                        ...
                        <div className="icon-box-content">
                          <p className="mb-1">Email. <span className="color-a">contact@example.com</span></p>
                          <p className="mb-1">Phone. <span className="color-a">+92 306 7093525</span></p>
                        </div>
                      </div>
                    </div>
                    <div className="icon-box section-b2">
                      ...
                      <div className="icon-box-content table-cell">
                        ...
                        <div className="icon-box-content">
                          <p className="mb-1">Lahore, Pakistan <br /> </p>
                        </div>
                      </div>
                    </div>
